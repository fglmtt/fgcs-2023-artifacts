 ...
 * WLDT Event Bus
 */
public class MyDefaultWldtEventLogger implements IWldtEventLogger {

    private static final Logger logger = LoggerFactory.getLogger(MyDefaultWldtEventLogger.class);
