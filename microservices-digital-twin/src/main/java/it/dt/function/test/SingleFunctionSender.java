 ...
 */
public class SingleFunctionSender {

    private final static Logger logger = LoggerFactory.getLogger(SingleFunctionSender.class);

    //private static String TEST_FUNCTION_FILE_PATH = "functions/test_function.py";

    private static String TEST_FUNCTION_FILE_PATH = "functions/test_function2.py";

    //private static String TEST_FUNCTION_FILE_PATH = "functions/json_prime_number_function.py";
