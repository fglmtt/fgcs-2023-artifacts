...
public class FunctionConsumer {
    ...
    private final static Logger logger = LoggerFactory.getLogger(FunctionConsumer.class);
    ...
    public static void main(String [ ] args) {
        ...
        try{
            ...
            client.subscribe(FunctionConfiguration.FLUID_DT_FUNCTION_ACTION_TOPIC, (topic, msg) -> {
                ...
                String outputFileName = String.format("functions/%d.py", System.currentTimeMillis());
